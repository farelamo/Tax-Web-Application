...
@section('content')
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-dark font-weight-bold">Edit Pembelian</h1>
		</div>

		<div class="row">
			<div class="mx-auto col-12 col-md-8">
				<form action="{{ route('pembelian.update', ['pembelian' => $data->id]) }}" method="post" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					...
					<div class="row mb-2">
						...
						<div class="col-6">
							...
							<input type="number" class="form-control form-control-solid mb-2" id="total" name="total" value="{{old('total') ?? $data->total}}">
							@error('total')
								<span>{{$message}}</span>
							@enderror
						</div>
