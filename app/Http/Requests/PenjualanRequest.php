...
class PenjualanRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tax_year'      => 'required|date|date_format:Y-m-d',
    ...
    public function messages()
    {
        return [
            ...
            'unit_price.decimal'        => 'Harga satuan harus berupa angka',
            'amount.required'           => 'Jumlah barang harus diisi',
            'amount.decimal'            => 'Jumlah barang harus berupa angka',
            'total.required'            => 'Harga total harus diisi',
            'total.decimal'             => 'Harga total harus berupa angka',
            'discount.required'         => 'Discount harus diisi',
            'discount.decimal'          => 'Discount harus berupa angka',
            'dpp.required'              => 'Dpp harus diisi',
            'dpp.decimal'               => 'Dpp harus berupa angka',
